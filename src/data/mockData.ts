...
export const salesContracts: SalesContract[] = [
  { id: 'ct-1', contractNo: 'CT20240001', plotId: 'plot-1', plotPosition: '松柏园-1排1号', buyerName: '张明远', buyerPhone: '13800138001', buyerIdCard: '110101196001011234', deceasedName: '张老先生', price: 68000, paymentMethod: 'full', paidAmount: 68000, status: 'completed', signingDate: '2024-01-15', notes: '' },
  { id: 'ct-2', contractNo: 'CT20240002', plotId: 'plot-2', plotPosition: '松柏园-1排2号', buyerName: '李文华', buyerPhone: '13900139002', buyerIdCard: '110101196502022345', price: 68000, paymentMethod: 'installment', paidAmount: 34000, status: 'signed', signingDate: '2024-02-20' },
  { id: 'ct-3', contractNo: 'CT20240003', plotId: 'plot-9', plotPosition: '梅花园-1排1号', buyerName: '王建国', buyerPhone: '13700137003', buyerIdCard: '110101197003033456', deceasedName: '王老夫人', price: 38000, paymentMethod: 'full', paidAmount: 38000, status: 'completed', signingDate: '2024-03-10' },
  { id: 'ct-4', contractNo: 'CT20240004', plotId: 'plot-49', plotPosition: '兰亭园-1排1号', buyerName: '陈世杰', buyerPhone: '13600136004', buyerIdCard: '110101195804044567', price: 128000, paymentMethod: 'full', paidAmount: 128000, status: 'completed', signingDate: '2024-04-05' },
  { id: 'ct-5', contractNo: 'CT20240005', plotId: 'plot-3', plotPosition: '松柏园-1排3号', buyerName: '赵德华', buyerPhone: '13500135005', buyerIdCard: '110101197205055678', price: 68000, paymentMethod: 'installment', paidAmount: 20000, status: 'pending', signingDate: '2024-05-18' },
  { id: 'ct-6', contractNo: 'CT20240006', plotId: 'plot-10', plotPosition: '梅花园-1排2号', buyerName: '刘美玲', buyerPhone: '13400134006', buyerIdCard: '110101197506066789', deceasedName: '刘老先生', price: 38000, paymentMethod: 'full', paidAmount: 38000, status: 'completed', signingDate: '2024-06-22' },
  { id: 'ct-7', contractNo: 'CT20240007', plotId: 'plot-50', plotPosition: '兰亭园-1排2号', buyerName: '黄志强', buyerPhone: '13300133007', buyerIdCard: '110101196807077890', price: 128000, paymentMethod: 'installment', paidAmount: 64000, status: 'signed', signingDate: '2024-07-14' },
  { id: 'ct-8', contractNo: 'CT20240008', plotId: 'plot-85', plotPosition: '竹韵园-1排1号', buyerName: '周秀英', buyerPhone: '13200132008', buyerIdCard: '110101197108088901', price: 68000, paymentMethod: 'full', paidAmount: 68000, status: 'completed', signingDate: '2024-08-30' },
]
...
export const customerRecords: CustomerRecord[] = [
  ...
  },
  {
    ...
    relocationRequest: { type: 'relocate_in', toPlot: '兰亭园-1排1号', reason: '家族合葬需要', status: 'completed', fee: 5000 },
  },
  {
